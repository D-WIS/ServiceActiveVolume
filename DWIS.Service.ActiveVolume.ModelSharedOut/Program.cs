...
class Program
{
    ...
    private static readonly string JSON_BUNDLE = "ActiveVolumeMergedModel.json";
    private static readonly string CSHARP_MODEL = "ActiveVolumeMergedModel.cs";

    // ### BEGIN CODE SPECIFIC TO ModelSharedIn 3/3 ###
    private static readonly string NAMESPACE = "NORCE.Drilling.ActiveVolume.ModelSharedOut";
    private static readonly string SHARED_FOLDER = "DWIS.Service.ActiveVolume.ModelSharedOut";
