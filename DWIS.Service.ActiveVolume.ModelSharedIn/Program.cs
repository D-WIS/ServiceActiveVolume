...
class Program
{
    ...
    private static readonly string NAMESPACE = "NORCE.Drilling.ActiveVolume.ModelShared"; // should be the same as for ModelSharedIn to avoid type name collision
    private static readonly string SHARED_FOLDER = "DWIS.Service.ActiveVolume.ModelSharedIn";
